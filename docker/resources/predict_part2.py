...
def get_data(feat_path):
    ...
    # Part 2
    for video_name in feats_keys[int(len(feats_keys) / 3): int(len(feats_keys) * 2 / 3)]:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Predict the results (part 2)')
    ...
    parser.add_argument('--output', default='/data/part2.pickle', help='result (output)')
