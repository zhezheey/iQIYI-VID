...
def get_data(feat_path):
    ...
    # Part 3
    for video_name in feat_keys[int(len(feat_keys) * 2 / 3): int(len(feat_keys))]:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Predict the results (part 3)')
    ...
    parser.add_argument('--output', default='/data/part3.pickle', help='result (output)')
