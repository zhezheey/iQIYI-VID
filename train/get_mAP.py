...
if __name__ == '__main__':
    ...
    parser.add_argument('--result', default='../result/result.txt', help='your own result (txt)')
    parser.add_argument('--gt', default='../data/val_gt.txt', help='the ground truth (txt)')
    args = parser.parse_args()
    
    print('mAP: {}'.format(calculate_map(args.gt, args.result)))